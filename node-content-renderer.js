      ...
      >
        ...
        >
          ...
          <div className={styles.rowFunc}>
            {nodeFunc ? nodeFunc.map((func)=> (
              <div className={styles.boxFunc} key={func.id}>
                <div 
                  className={styles.blockFunc}
                  >
                  <div 
                    className={styles.textFunc}>
                    {func.name}
                  </div>
                  
                </div>
                <div
                  className={styles.toolbarFunc}>
                  {buttonsfunc.map((btn, index)=>(
                    <div
                      key={index}
                      className={styles.buttonFunc}
                    >
                      {
                        <button onClick={()=> btn.func(func.id)}>{btn.name}</button>
                      }
                    </div>
                  ))}
                </div>
...
CustomThemeNodeContentRenderer.propTypes = {
  ...
  buttonsfunc: PropTypes.arrayOf(PropTypes.object),
